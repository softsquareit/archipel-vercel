...
const VideoTestimonialCarousel = () => {
  ...
  return (
    ...
    <div className="md:  xl:mx-auto overflow-hidden relative pb-16">
      ...
      <div
        className="flex gap-6 overflow-x-auto scrollbar-hide py-4 px-2 snap-x snap-mandatory flex justify-center"
        ref={carouselRef}
      >
        ...
        {testimonialsConfig.map((testimonialConf, i) => {
          ...
          return (
            <div
              ...
              className={`relative min-w-[280px] max-w-xs rounded-xl m-8 z-10 ${testimonialConf.bgColor} shadow-lg ${i % 2 === 0 ? "rotate-3" : "-rotate-3"
      ...
      <div className="absolute bottom-4 left-0 right-0 flex justify-center space-x-3">
        {testimonialsConfig.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 ${index === activeIndex
